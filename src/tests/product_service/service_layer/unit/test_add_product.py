...
def test_add_product():
    ...
    ingredient_1 = Ingredient(id=uuid.uuid4(), name='мука пшеничная')
    ingredient_2 = Ingredient(id=uuid.uuid4(), name='вода')
    ingredient_3 = Ingredient(id=uuid.uuid4(), name='дрожжи хлебопекарные')
    supplier = Supplier(
        id=uuid.uuid4(),
